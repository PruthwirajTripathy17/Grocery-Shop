...
const Footer = () => {
  ...
  // const sendMessage = () => {
  //   window.location = `https://wa.me/7077886264?text=${message}`;
  // };
  return (
    <>
      <footer>
        <section className="footer">
          <div className="box-container">
            <div className="box">
              ...
              <div className="share">
                {/* <Link>
                  <i
                    onClick={() => {
                      window.location = `https://wa.me/7077886264?text=Say Hello..!!`;
                    }}
                  >
                    {<IoLogoWhatsapp />}
                  </i>
            ...
            <div className="box">
              ...
              <a href="mailto:pruthwirajtripathy2@gmail.com" className="links">
                <i>
                  <MdOutlineMarkEmailRead />
                </i>
                pruthwirajtripathy2@gmail.com
              </a>
          ...
          <div className="credit">
            Created By <span>Pruthwiraj Tripathy</span> | All Rights Reserved
          </div>
        </section>
      </footer>
    </>
